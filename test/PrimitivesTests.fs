...
let ``cross product of two tuples`` () =
    let a = vector 1.0 2.0 3.0
    let b = vector 2.0 3.0 4.0
    Assert.VectorEqual(vector -1.0 2.0 -1.0, cross a b)
    Assert.VectorEqual(vector 1.0 -2.0 1.0, cross b a)
